...
public class VendorTable {
    ...
    public VendorTable() throws SQLException, ClassNotFoundException {
        objDBHandler = new DBHandler();
        imgLogo = new ImageModel();
        jFrame = new JFrame("Vendor Table");
        ...
        Object[] arrColumn = {"ID", "First name", "Last name","Stall No.",
                "Stall Name","Age" ,"Temperature", "Phone Number",
        ...
        ResultSet objResultset = objDBHandler.vendorRead();
        ArrayList<Vendor> arrVendor = new ArrayList<>();
        while (objResultset.next()){
            objVendor =   new Vendor(objResultset.getInt("idvendor"), objResultset.getString("firstname"),
                    objResultset.getString("lastname"), objResultset.getString("stallno"), objResultset.getString("stallname"),
            ...
            arrVendor.add(objVendor);
        }
        objResultset.close();
        for (Vendor objValue : arrVendor) {
            arrRow[0] = objValue.getIntVendorID();
            arrRow[1] = objValue.getStrFirstName();
            arrRow[2] = objValue.getStrLastName();
            arrRow[3] = objValue.getStrStallNo();
            arrRow[4] = objValue.getStrStallName();
