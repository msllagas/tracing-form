...
public class MaintenanceTable {
    ...
    public MaintenanceTable() throws SQLException, ClassNotFoundException {
        objDBHandler = new DBHandler();
        imgLogo = new ImageModel();
        jFrame = new JFrame("Maintenance Table");
        ...
        Object[] arrColumn = {"ID", "First name", "Last name","ID No.",
        ...
        ResultSet objResultset = objDBHandler.maintenanceRead();
        ArrayList<Maintenance> arrMaintenance = new ArrayList<>();
        while (objResultset.next()){
            objMaintenance =   new Maintenance(objResultset.getInt("idmaintenance"), objResultset.getString("firstname"),
                    objResultset.getString("lastname"), objResultset.getString("idno"), objResultset.getString("work"),
            ...
            arrMaintenance.add(objMaintenance);
        }
        objResultset.close();
        for (Maintenance objValue : arrMaintenance) {
            arrRow[0] = objValue.getIntMainID();
            arrRow[1] = objValue.getStrFirstName();
            arrRow[2] = objValue.getStrLastName();
            arrRow[3] = objValue.getStrIDNo();
                ...
                btnDelete.addActionListener(e1 -> {
                    ...
                    if (i>=0) {
                        try {
                            ...
                            model.removeRow(i);
                            objDBHandler.maintenanceDelete(j);
