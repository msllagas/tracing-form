...
public class FoodDelivery {
    ...
    public FoodDelivery(int intDeliID, String strFirstName, String strLastName,
                        String strPlateNo, String strCompany, int intAge,
                        double dblTemp, String strPhoneNo, String strEmail,
                        String strGender, String strAddress, Timestamp timeIn) {
        this.setIntDeliID(intDeliID);
    ...
    public int getIntDeliID() {
        return intDeliID;
    }

    public void setIntDeliID(int intDeliID) {
        this.intDeliID = intDeliID;
    }
}
